...
export const DEFAULT_FEEDBACK_DATA = [
  {
    ...
    "feedback_text": "La scrivania è comoda ma la connessione internet è spesso lenta.",
  ...
  },
  {
    ...
    "feedback_text": "Troppo rumore vicino alla zona server, difficile concentrarsi.",
  ...
  },
  {
    ...
    "department": "Product",
    "feedback_text": "Le sale riunioni sono spesso occupate, difficile pianificare meeting.",
    "overall_sentiment": "negative",
  ...
  },
  {
    ...
    "submitted_at": "2026-01-13",
    "department": "Design",
    "feedback_text": "La luce naturale in ufficio è ottima, migliora la concentrazione.",
  ...
  },
  {
    ...
    "department": "HR",
    "feedback_text": "Il bagno è sempre pulito ma spesso manca la carta igienica.",
    "overall_sentiment": "neutral",
    "overall_sentiment_score": -0.1,
    "opinions": [
      {
  ...
  },
  {
    ...
    "submitted_at": "2026-01-14",
    "department": "Sales",
    "feedback_text": "La mensa offre molta varietà di cibi, ma il prezzo è un po’ alto.",
    "overall_sentiment": "neutral",
  ...
  },
  {
    ...
    "feedback_text": "Il parcheggio aziendale è spesso pieno, trovare posto è difficile.",
    "overall_sentiment": "negative",
    "overall_sentiment_score": -0.7,
    "opinions": [
      {
  ...
  },
  {
    ...
    "department": "Engineering",
    "feedback_text": "La temperatura in ufficio varia troppo, a volte troppo freddo, altre troppo caldo.",
    "overall_sentiment": "negative",
    "overall_sentiment_score": -0.6,
    "opinions": [
      {
  ...
  },
  {
    ...
    "submitted_at": "2026-01-16",
    "department": "Design",
    "feedback_text": "La sedia ergonomica è molto comoda, ma alcuni monitor sono mal posizionati.",
    "overall_sentiment": "neutral",
  ...
  },
  {
    ...
    "department": "Engineering",
    "feedback_text": "La connessione Wi-Fi nell’area open space è instabile e rallenta il lavoro.",
    "overall_sentiment": "negative",
  ...
  },
  {
    ...
    "department": "Sales",
    "feedback_text": "Il tempo di viaggio per arrivare in ufficio è piuttosto lungo.",
    "overall_sentiment": "negative",
    "overall_sentiment_score": -0.5,
    "opinions": [
      {
        "opinion_id": 17,
        "feedback_excerpt": "tempo di viaggio per arrivare in ufficio è piuttosto lungo",
        "category": "commuting",
  ...
  },
  {
    ...
    "submitted_at": "2026-01-18",
    "department": "Marketing",
    "feedback_text": "Gli spazi comuni sono piacevoli ma a volte un po' rumorosi.",
    "overall_sentiment": "neutral",
  ...
  },
  {
    ...
    "department": "HR",
    "feedback_text": "Le sedie ergonomiche sono molto comode e migliorano la postura.",
    "overall_sentiment": "positive",
  ...
  },
  {
    ...
    "submitted_at": "2026-01-19",
    "department": "IT Operations",
    "feedback_text": "Il parcheggio è ampio ma spesso manca l’illuminazione nelle ore serali.",
    "overall_sentiment": "neutral",
    "overall_sentiment_score": -0.1,
    "opinions": [
      {
  ...
  },
  {
    ...
    "department": "Engineering",
    "feedback_text": "Le scrivanie sono abbastanza spaziose per lavorare con più monitor.",
    "overall_sentiment": "positive",
    "overall_sentiment_score": 0.6,
    "opinions": [
      {
  ...
  },
  {
    ...
    "submitted_at": "2026-01-21",
    "department": "Product",
    "feedback_text": "I mezzi pubblici per raggiungere l’ufficio sono abbastanza comodi.",
    "overall_sentiment": "positive",
    "overall_sentiment_score": 0.43,
    "opinions": [
      {
        "opinion_id": 27,
        "feedback_excerpt": "mezzi pubblici per raggiungere l’ufficio sono abbastanza comodi",
        "category": "commuting",
